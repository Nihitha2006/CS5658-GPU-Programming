...
int main() {
    ...
    for (int i = 0; i < deviceCount; ++i) {
        ...
        std::cout << "  Local L1 Cache supported:    ";
        ...
        std::cout << "  Constant Memory Size :       " << prop.totalConstMem / 1024 << " KB" << std::endl;
        std::cout << "  Max Threads Dimension :      " << "(" << prop.maxThreadsDim[0] << "," << prop.maxThreadsDim[1] << "," << prop.maxThreadsDim[2] << ")" << std::endl;
        std::cout << "  Max Grid Dimension :         " << "(" << prop.maxGridSize[0] << "," << prop.maxGridSize[1] << "," << prop.maxGridSize[2] << ")" << std::endl;
